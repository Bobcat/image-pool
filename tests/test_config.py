...
class ConfigTests(unittest.TestCase):
    ...
    def test_default_settings_have_sdxl_model_disabled(self):
        ...
        self.assertEqual(model.generation_parameters["sampler"]["allowed_values"], ["euler", "euler_a", "dpmpp_2m", "lcm"])
        self.assertEqual(model.generation_parameters["sampler"]["labels"]["lcm"], "LCM")
        self.assertEqual(model.generation_parameters["negative_prompt"]["default"], "")
        self.assertEqual(model.generation_parameters["lora_scale"]["label"], "lora_strength")
